(function publishUnit4LocationStudy(root) {
  ...
  function failRecord(record, rule) {
    throw new Error(`Invalid Unit 4 study record ${record?.id || '(missing ID)'}: ${rule}`);
  }
